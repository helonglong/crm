...
<div class=" con1" style="height: 60px;padding-left: 20px;padding-right: 23px">
  ...
  <div class="layui-inline" style="width: 50px;float: right;margin-right: 50px;margin-top: 7px">
    <button id="newlyBuild" class="layui-btn">新建</button>
  </div>
            ...
            tableIns = table.render({
                ...
                cols: [
                    [ //表头
                        ...
                        align: 'center',
                        templet: function (d) {
                            return '<span lay-event="edit" title="编辑" class="list_bianji" style="cursor: pointer;color: #5FB878"> ' +
