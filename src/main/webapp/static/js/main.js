...
$(".pull-right").on("click",function () {
    alert(555);
    $(this).parent("section").height(50);
    $(this).children("i").removeClass("icon-xiangxiazhanhang");
    $(this).children("i").addClass("icon-xiangshangzhanhang");
});
// $(".icon-xiangxiazhanhang").on("click",function () {
//     $(this).parent("section").height(50);
//     $(this).removeClass("icon-xiangxiazhanhang");
//     $(this).addClass("icon-xiangshangzhanhang");
// });*/
